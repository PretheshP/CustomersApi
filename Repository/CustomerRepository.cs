...
namespace MFPE_CustomerApi.Repository
{
    public class CustomerRepository : IRepository<Customer>
    {
        ...
        {
            //Convert.ToDateTime("1998-11-20 01:02:01 AM")
            //Convert.ToDateTime("1999-11-10 02:02:01 AM")
            new Customer {CustomerId = 1, Name = "Akshay", Address = "ERNAKULAM",  PANno = "DCRP124" , DOB = "1998-11-20 01:02:01 AM"},
            new Customer {CustomerId = 2, Name = "BABU", Address = "Delhi", PANno = "DCRP23456", DOB = "1999-11-10 02:02:01 AM"}
        };
        /// <summary>
